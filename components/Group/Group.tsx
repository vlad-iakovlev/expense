  ...
  return (
    <>
      ...
      <Columns className="md:grid-rows-[auto_auto_auto_1fr] lg:grid-rows-[auto_auto_1fr] xl:grid-rows-[auto_1fr]">
        ...
        <WalletsCard className="row-start-3 col-start-1 xl:row-span-full xl:col-start-2" />
        <OperationsCard className="row-start-4 col-start-1 lg:row-span-full lg:col-start-2 xl:col-start-3" />
        <StatisticsCard className="row-start-5 col-start-1 md:row-span-full md:col-start-2 lg:col-start-3 xl:col-start-4" />
      </Columns>
    </>
  )
}
