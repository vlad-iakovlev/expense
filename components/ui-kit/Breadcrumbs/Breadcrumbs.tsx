...
export const Breadcrumbs = ({
  ...
  return (
    <>
        ...
        >
          {parents.map((parent) => (
            <Fragment key={parent.href}>
              <NextLink
                className="min-w-0 truncate text-lg font-medium leading-6 text-cyan-900"
      ...
      {mobileBack ? (
        <NextLink
          className="-mb-4 -mt-2 flex items-center gap-2 truncate text-lg font-medium leading-6 text-cyan-900 md:hidden"
